...
object VillagerItems {
    ...
    val ZOMBIE_SIGNAL: SlimefunItemStack =
        SEText.localized(ZOMBIE_SIGNAL_ID, Material.ZOMBIE_HEAD, "items.villager.zombie-signal")
     ...
     */
    val VILLAGER_CATCHER: SlimefunItemStack =
        SEText.localized(VILLAGER_CATCHER_ID, Material.GLASS_BOTTLE, "items.villager.catcher")
    ...
    val VILLAGER_TRADER: SlimefunItemStack =
        SEText.localized(VILLAGER_TRADER_ID, Material.GLASS, "items.villager.trader")
    ...
    val IRON_FARM: SlimefunItemStack =
        SEText.localized(IRON_FARM_ID, Material.GLASS, "items.villager.iron-farm")
    ...
    val IRON_FARM_SPEED_UPGRADE: SlimefunItemStack =
        SEText.localized(IRON_FARM_SPEED_UPGRADE_ID, Material.CLOCK, "items.villager.iron-farm-speed-upgrade")
    ...
    val VILLAGER_SCHOOL: SlimefunItemStack =
        SEText.localized(VILLAGER_SCHOOL_ID, Material.LECTERN, "items.villager.school")
    ...
    val VILLAGER_HEALER: SlimefunItemStack =
        SEText.localized(VILLAGER_HEALER_ID, Material.GOLD_BLOCK, "items.villager.healer")
    ...
    val FORGETTING_POTION: SlimefunItemStack =
        SEText.localized(FORGETTING_POTION_ID, Material.POTION, "items.villager.forgetting-potion")
